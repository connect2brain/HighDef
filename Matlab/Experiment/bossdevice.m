classdef bossdevice < handle
    ...
    methods
        function obj = bossdevice()
            ...
            emg_signal_id = getsignalid(obj.tg, 'UDP/raw_aux') + int32([0 1 2 3]);
...
%             triggersignal=getsignalid(obj.tg, 'GEN\Compare to Zero\Compare');
   %         obj.scope_emg.TriggerSignal =  triggersignal+int32([0]);
        ...
        function pulse_count = get.pulse_count(obj)
            pulse_count = getsignal(obj.tg, 'pulse_count');
        end
