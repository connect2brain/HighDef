...
% NEXT STEP: run script "run_experiment _conventional" 

% VERSION HISTORY:
% 27.04.2023: structured script from D. Vetter "initialize_experiment"
...
bd.aux_channels = 4; % 2 emg channels each side %aj: should this be 8?
bd.eeg_channels = 10; % ?
...
% dbsp_control_app(rtcls);
% dbsp_amplitude_threshold_tracking_app(rtcls);
